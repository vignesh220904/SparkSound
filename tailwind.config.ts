  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        sound: {
          devotional: "hsl(var(--sound-devotional))",
          emergency: "hsl(var(--sound-emergency))",
          general: "hsl(var(--sound-general))",
          temple: "hsl(var(--sound-temple))",
        },
      },
      backgroundImage: {
      ...
      keyframes: {
        ...
        "emergency-flash": {
          ...
          "50%": { backgroundColor: "hsl(15 100% 50%)" },
        },
        "slide-up": {
